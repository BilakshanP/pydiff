...
<details class='target-section' id='target-N' open>
  <summary>[> triangle] <h2>Target: ref (sha) [kind-chip]</h2> [[fs] btn]</summary>
  <div class='target-body'>
    <div class='summary-card'>... badges ... TOC ...</div>
    <details class='file-container' open>
      <summary class='file-header'>[status-chip filename] [<- ->] [[fs]] [^ Top]</summary>
...
- **Triangle on LEFT of target title; fullscreen on RIGHT.** Order: `[>] [Target: ref (sha) chip] ... [[fs]]`.
